...
export default function BuyClient({ products }: any) {
  ...
  return (
    <section className="min-h-screen bg-[#fafafa] pt-16 md:pt-32 pb-16 px-4 md:px-8 flex flex-col">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3 md:gap-8 max-w-7xl mx-auto">
          ...
          {products?.map((product: any, idx: number) => (
            ...
            >
              <div className="p-2 md:p-6 aspect-square flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[#ff3366]/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                <Image
                  src={product.imageUrl}
                  className="object-contain transform group-hover:scale-110 transition-transform duration-700 relative z-10 drop-shadow-2xl"
                  alt={product.title}
                  fill
              ...
              <div className="p-3 md:p-8 pt-0 flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                     ...
                     <p className="text-[6px] md:text-[9px] text-gray-400 uppercase font-black tracking-widest truncate">Collection 01</p>
                  </div>
                  <h2 className="text-[10px] md:text-xl font-bold md:font-black text-black tracking-tight leading-snug line-clamp-2 min-h-[28px] md:min-h-0">
                    {product.title}
                  </h2>
                </div>
